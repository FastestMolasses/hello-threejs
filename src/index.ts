...
import baseCharacter from './assets/Suit_Male.fbx';
import building from './assets/building.fbx';
...
function init() {
    ...
    let renderResolution = screenResolution.clone().divideScalar(8);
    renderResolution.x |= 0;
    renderResolution.y |= 0;
    // let renderResolution = new Vector2(320, 180);
...
function animate() {
    ...
    // if (mech) mech.rotation.y = (Math.floor(t * 8) * Math.PI) / 32;
    composer.render();
}
